...
@section('content')
    <div class="container">
        <div class="form">
            <h2 class="display-4"><span data-feather="log-out"></span>{{ __('Job Announcement') }}</h2>
            <form method="POST" action="{{route('job.store')}}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="job-title" type="text" class="form-control @error('title') is-invalid @enderror" name="tile" value="{{ old('job-title') }}" required autocomplete="job-title" autofocus>
                        @error('job-title')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                                <textarea id="job-description" class="form-control @error('description') is-invalid @enderror" name="description" required autocomplete="job-description" autofocus>
                                </textarea>
